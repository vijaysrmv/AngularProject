...
export class GettingStartedComponent implements OnInit {
	...
	ownerShipStructureArray:any = ['Sole Proprietorship','General Partnership','Free Zone Establishment (FZEs)','Public Joint Stock Co. ','Private Joint Stock Co.','Limited Liability Co.','Partnership Limited By Shares','Branches of Foreign Co.','Other (Specify)']
