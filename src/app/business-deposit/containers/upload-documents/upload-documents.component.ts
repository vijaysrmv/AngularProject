...
export class UploadDocumentsComponent implements OnInit {
	...
	// deleteDocIds = [];
	uploadDocumentArray =['Article Of Incorporation','Resolution Document','Beneficiary OwnerShip Form','Fictitious Buisness Name Statemenr','Certificate Of Qualification','Bylaws']
	documentType: any;
	documents: Array<any>;
	imgerror = false;
